...
exports.pushMessage = function(req, res, next){
    ...
    async.series([
                ...
                .end(function(res){
                    ...
                    request.post(url)  //第二遍
                        ...
                        .end(function(res){
                            ...
                            var sendData3 = '';
                            for (property in data) {
                                 sendData3 = sendData3 + property + '=' + encodeURIComponent(data[property]) + "&";
                            }
                            sendData3 = sendData3.substring(0, sendData3.length - 1);
                            console.log("第三遍检查...");
                            request.post(url) //第三遍
                                ...
                                .end(function(res){
                                    ...
                                    console.log("检查广告...");
                                    request.post('https://mp.weixin.qq.com/cgi-bin/masssend?action=check_ad&token=' + loadResult.cookie + '&lang=zh_CN')
                                        .set('Cookie', loadResult.cookie)
                                        .set("Accept-Encoding" , "gzip,sdch")
                                        .set("Accept-Language","zh-cn,zh;q=0.8,en-us;q=0.5,en;q=0.3")
                                        .set("Accept" ,"application/json, text/javascript, */*; q=0.01")
        ...
        function(cb) {      //推送消息
            ...
            console.log("推送消息...");
            var url = 'https://mp.weixin.qq.com/cgi-bin/masssend?t=ajax-response&req_need_vidsn=1&add_tx_video=1&token='+ loadResult.token +'&lang=zh_CN';
            request.post(url)
                .set('Cookie', loadResult.cookie)
                .set("Accept-Encoding" , "gzip,sdch")
				.set("Accept-Language","zh-cn,zh;q=0.8,en-us;q=0.5,en;q=0.3")
