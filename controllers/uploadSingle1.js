...
exports.uploadSingle = function (req, res, next) {
    try {
        ...
        async.series([
            ...
            function (cb) {
                content.multi_item[0].content = replaceContent(content.multi_item[0].content, schoolEx, face);
                content.multi_item[0].title = replaceTitle(content.multi_item[0].title, schoolEx);
                cb();
            },
            function (cb) {
                if (articleNum > 1) {
                    content.multi_item[1].content = replaceContent(content.multi_item[1].content, schoolEx, face);
            ...
            function (cb) {
                if (articleNum > 2) {
                    content.multi_item[2].content = replaceContent(content.multi_item[2].content, schoolEx, face);
            ...
            function (cb) {
                if (articleNum > 3) {
                    content.multi_item[3].content = replaceContent(content.multi_item[3].content, schoolEx, face);
            ...
            function (cb) {
                if (articleNum > 4) {
                    content.multi_item[4].content = replaceContent(content.multi_item[4].content, schoolEx, face);
            ...
            function (cb) {
                if (articleNum > 5) {
                    content.multi_item[5].content = replaceContent(content.multi_item[5].content, schoolEx, face);
